...
//        float strokeStart = adjustedPercent * .8f;// TODO: 2016/10/13 0013
//        mProgress.setStartEndTrim(0f, Math.min(MAX_PROGRESS_ANGLE, strokeStart));
//        mProgress.setArrowScale(Math.min(1f, adjustedPercent));
//
//        float rotation = (-0.25f + .4f * adjustedPercent + tensionPercent * 2) * .5f;
//        mProgress.setProgressRotation(rotation);
        mProgress.setPercentage(tensionPercent * 2); // 最高值0.5
...
//            mProgress.setStartEndTrim(0f, 0f); // TODO: 2016/10/13 0013
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(PullToRefreshView parent, @Nullable View child);
    }
}
